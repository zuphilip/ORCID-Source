...
<header class="header center" ng-controller="headerCtrl">
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-3 reset logo">
                <h1>
                    <a href="${aboutUri}"><img
            ...
            <div class="search col-md-8 col-sm-12 col-xs-12"
    ...
    <div style="background-color: #338caf; ">
        <div class="container">
            <!-- .row -->
            <div class="row">           
